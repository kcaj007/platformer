...
function animateIdle () {
    ...
    mainIdleLeft.addAnimationFrame(img`
        ...
        . f d d f d d d d f d d d f f . 
        . f d d f d d d d f d d d f . . 
        . f d d d d d d d d d d d f . . 
        . f 6 8 8 8 8 8 8 8 8 6 9 f . . 
        . f d d 8 8 8 8 8 8 d d d f . . 
        . f d f f f b b f f f d d f . . 
        . . f 8 8 8 8 8 8 8 8 8 9 f . . 
        . . . f 8 8 9 f f 8 8 9 f . . . 
        . . . f 8 8 9 f f 8 8 9 f . . . 
        . . . . f f f . . f f f . . . . 
        `)
...
function animateRun () {
    ...
    mainRunLeft.addAnimationFrame(img`
        ...
        . . f 8 8 8 8 8 8 8 8 9 f f . . 
        . . . f 8 8 9 f f 8 8 8 f f . . 
        . . . . f f f . f f f f f . . . 
        `)
    mainRunLeft.addAnimationFrame(img`
        . . . . . . . . . . . . . . . . 
    ...
    mainRunLeft.addAnimationFrame(img`
        ...
        . f d d d d d d d d d f . . . . 
        . . f 8 8 8 8 8 8 8 9 f . . . . 
        . f d d d 9 8 8 8 8 9 f . . . . 
        f f f d d f f f f f f f . . . . 
        f f f 8 8 8 8 8 8 8 9 f . . . . 
        . f 8 8 9 f 8 8 9 f f . . . . . 
        . f f f f . f f f . . . . . . . 
        `)
    ...
    mainRunRight.addAnimationFrame(img`
        ...
        . . f f 9 8 8 8 8 8 8 8 8 f . . 
        . . f f 8 8 8 f f 9 8 8 f . . . 
        . . . f f f f . . f f f . . . . 
        `)
    mainRunRight.addAnimationFrame(img`
        . . . . . . . . . . . . . . . . 
    ...
    mainRunRight.addAnimationFrame(img`
        ...
        . . . . f d d d d d d d d d f . 
        . . . . f 9 8 8 8 8 8 8 8 f . . 
        . . . . f 9 8 8 8 8 b d d d f . 
        . . . . f f f f f f f d d f f f 
        . . . . f 9 8 8 8 8 8 8 8 f f f 
        . . . . . f f 9 8 8 f 9 8 8 f . 
        . . . . . . . f f f . f f f . . 
        `)
}
function animateJumps () {
    ...
    for (let index = 0; index < 30; index++) {
        mainJumpLeft.addAnimationFrame(img`
            ...
            . d 6 9 8 8 8 8 8 8 8 8 9 6 d . 
            . d 6 8 8 8 8 8 8 8 8 8 8 6 d . 
